...
SELECT
    ...
    -- Определяем клиента как нового или повторного на основании порядка его кредитов.    
    CASE
...
WHERE c.disb_date >= DATE '2025-07-01'
    ...
    AND c.product_id NOT IN (NOT IN (1258,1244,1238,1248,1241,1291,1237,1240,1210,1242,1239,1289,1206,1223,1288,1207,1224,1205,1269)
